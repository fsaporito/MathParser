...
public class JavaDeriveGui implements ActionListener {
	...
	private void initializeObjects() {
		...
		this.buttonDerive = new JButton("Derive");
	...
	private void createGui() {
		...
		this.panelIO.add(this.buttonDerive);
		...
		this.panelArithmeticOperatorsWEST.add(this.buttonX);
		...
		this.buttonDerive.addActionListener(this);
	...
	public void actionPerformed (ActionEvent e) {
		...
		if (e.getActionCommand().equals ("Derive") || e.getActionCommand().equals ("=")) {
